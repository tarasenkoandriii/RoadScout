...
// Простая интерполяция вида "{key}" -> params.key — этого достаточно для всех строк словаря
// (нет плюрализации/сложных ICU-правил, но и строк, которым это было бы нужно, тоже нет:
// единственные варьируемые числа — расстояния/минуты, которые везде идут с одной формой).
