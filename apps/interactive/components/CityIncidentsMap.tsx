...
//
// ⚠️ ЧЕСНО / НЕ ВИКОРИСТОВУЄТЬСЯ — за прямим запитом користувача ("дороги и инциденты должны
// быть в одном слое") CityMapPanel.tsx більше НЕ імпортує й НЕ рендерить цей компонент: раніше
// окрема вкладка "Інциденти" (ця схематична карта) стояла поряд із вкладкою "Дороги"
// (RoadMapLayer.tsx, яка й раніше показувала інциденти ПОВЕРХ реальної карти доріг) — тепер
// лишилась тільки остання, як єдиний комбінований шар. Файл навмисно НЕ видалено (раптом
// знадобиться десь ще), просто ніде більше не підключений.
