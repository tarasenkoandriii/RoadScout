...
export interface Dictionary {
  ...
  // ця вкладка й раніше показувала інциденти ПОВЕРХ карти доріг (не окремо), тому окрему
  // вкладку/ключ widget_layer_incidents прибрано як буквальний дублікат, а текст цієї
  // лишився "Дороги" — тепер єдина вкладка, що поєднує обидва.
