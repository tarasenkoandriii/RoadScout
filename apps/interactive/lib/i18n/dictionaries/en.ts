...
const dict: Dictionary = {
  ...
  feature_ar_scan_text: "Your phone's camera shows what's ahead on the road in real time.",
  feature_on_device_title: 'On-device privacy',
  feature_on_device_text: 'Calculations stay on your phone — coordinates never reach the server.',
  feature_registry_title: 'LiveAhead — shared registry',
  feature_registry_text: 'A shared, crowdsourced database of cameras and checkpoints, kept up by users.',
  feature_drive_mode_title: 'Drive Mode',
  feature_drive_mode_text: "Minimal hand input — safe to use while you're actually driving.",
  feature_confirm_title: 'Confirming reports',
  feature_confirm_text: 'The community confirms or disputes markers, keeping the data accurate.',
  feature_marketplace_title: 'Marketplace',
  feature_marketplace_text: 'Offer and demand inside the app — a two-way exchange mechanic.',
  feature_payment_title: 'Payments & Telegram Stars',
  feature_payment_text: 'Built-in payments — by card or Telegram Stars, no need to leave the app.',
  feature_kill_switch_title: 'Privacy kill switch',
  feature_kill_switch_text: "One tap instantly disables sensitive features whenever it's needed.",
