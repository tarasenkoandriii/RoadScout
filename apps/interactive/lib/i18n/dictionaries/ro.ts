...
const dict: Dictionary = {
  ...
  feature_ar_scan_text: 'Camera telefonului arată în timp real ce urmează pe drum.',
  feature_on_device_title: 'Confidențialitate on-device',
  feature_on_device_text: 'Calculele rămân pe telefon — coordonatele nu ajung niciodată pe server.',
  feature_registry_title: 'LiveAhead — registru comun',
  feature_registry_text: 'O bază de date comună, alimentată de utilizatori, cu camere și puncte de control.',
  feature_drive_mode_title: 'Mod șofer',
  feature_drive_mode_text: 'Interacțiune minimă cu mâinile — sigur de folosit chiar la volan.',
  feature_confirm_title: 'Confirmarea semnalărilor',
  feature_confirm_text: 'Comunitatea confirmă sau contestă marcajele, păstrând datele corecte.',
  feature_marketplace_title: 'Marketplace',
  feature_marketplace_text: 'Cerere și ofertă în interiorul aplicației — un mecanism de schimb bidirecțional.',
  feature_payment_title: 'Plăți și Telegram Stars',
  feature_payment_text: 'Plăți integrate — cu cardul sau prin Telegram Stars, fără a părăsi aplicația.',
  feature_kill_switch_title: 'Comutator de confidențialitate',
  feature_kill_switch_text: 'O atingere dezactivează instantaneu funcțiile sensibile, atunci când este nevoie.',
