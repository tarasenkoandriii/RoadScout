...
const dict: Dictionary = {
  ...
  feature_ar_scan_text: 'Die Kamera des Telefons zeigt in Echtzeit, was auf der Straße vor dir liegt.',
  feature_on_device_title: 'On-Device-Datenschutz',
  feature_on_device_text: 'Berechnungen bleiben auf dem Telefon — Koordinaten erreichen nie den Server.',
  feature_registry_title: 'LiveAhead — gemeinsames Register',
  feature_registry_text: 'Eine von Nutzern gepflegte, gemeinsame Datenbank von Kameras und Kontrollpunkten.',
  feature_drive_mode_title: 'Fahrmodus',
  feature_drive_mode_text: 'Minimale Bedienung per Hand — sicher nutzbar direkt am Steuer.',
  feature_confirm_title: 'Bestätigung von Meldungen',
  feature_confirm_text: 'Die Community bestätigt oder widerlegt Markierungen und hält die Daten so genau.',
  feature_marketplace_title: 'Marktplatz',
  feature_marketplace_text: 'Angebot und Nachfrage innerhalb der App — ein zweiseitiger Tauschmechanismus.',
  feature_payment_title: 'Zahlungen & Telegram Stars',
  feature_payment_text: 'Integrierte Zahlungen — per Karte oder mit Telegram Stars, ohne die App zu verlassen.',
  feature_kill_switch_title: 'Datenschutz-Notschalter',
  feature_kill_switch_text: 'Ein Tipp schaltet sensible Funktionen sofort aus, wann immer es nötig ist.',
