...
const dict: Dictionary = {
  ...
  feature_map_eyebrow: '// alle Funktionen',
  feature_map_title: 'Alles, was die App kann — auf einen Blick',
  feature_map_subtitle: 'Von AR-Scanning auf der Straße bis zu Datenschutz und Zahlungen — ein kurzer Überblick über die wichtigsten Funktionen.',
  feature_map_phone_alt: 'Ein Smartphone mit geöffneter Beyond-the-Wall-App: Karte und AR-Oberfläche auf dem Startbildschirm',
  feature_ar_scan_title: 'AR-Scanning',
  feature_ar_scan_text: 'Echtzeiterkennung und -visualisierung von Objekten.',
  feature_on_device_title: 'On-Device-KI',
  feature_on_device_text: 'Daten werden direkt auf deinem Gerät verarbeitet.',
  feature_live_map_title: 'Live-Karte',
  feature_live_map_text: 'Echtzeitkarte der Kameras und erkannten Objekte.',
  feature_drive_mode_title: 'Fahrmodus',
  feature_drive_mode_text: 'Ein auf den Fahrer ausgerichteter Modus mit minimaler Ablenkung.',
  feature_confirm_title: 'Verifizierung',
  feature_confirm_text: 'Die Bestätigung durch die Community erhöht die Datenzuverlässigkeit.',
  feature_navigation_title: 'Navigation',
  feature_navigation_text: 'Sicherere Navigation auf Basis erkannter Objekte.',
  feature_payment_title: 'Zahlungen',
  feature_payment_text: 'Kostenlos während der Testphase des Projekts.',
  feature_mode_switch_title: 'Modus wechseln',
  feature_mode_switch_text: 'Sofortiger Wechsel zwischen den Nutzungsmodi.',
  feature_community_title: 'Community',
  feature_community_text: 'Teile Informationen und lasse sie von der Community bestätigen.',
  feature_camera_detection_title: 'Kamera-Erkennung',
  feature_camera_detection_text: 'Erkenne Kameras und verstehe ihren Erfassungsbereich.',
