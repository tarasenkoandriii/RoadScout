...
const dict: Dictionary = {
  ...
  feature_ar_scan_text: 'Kamera telefónu v reálnom čase ukazuje, čo je pred vami na ceste.',
  feature_on_device_title: 'Súkromie on-device',
  feature_on_device_text: 'Výpočty zostávajú v telefóne — súradnice sa nikdy neposielajú na server.',
  feature_registry_title: 'LiveAhead — spoločný register',
  feature_registry_text: 'Spoločná databáza kamier a kontrolných bodov, ktorú dopĺňajú samotní používatelia.',
  feature_drive_mode_title: 'Režim vodiča',
  feature_drive_mode_text: 'Minimum úkonov rukami — bezpečné použitie priamo za volantom.',
  feature_confirm_title: 'Potvrdzovanie hlásení',
  feature_confirm_text: 'Komunita potvrdzuje alebo vyvracia značky, vďaka čomu sú dáta presné.',
  feature_marketplace_title: 'Trhovisko',
  feature_marketplace_text: 'Ponuka a dopyt priamo v aplikácii — obojsmerný mechanizmus výmeny.',
  feature_payment_title: 'Platby a Telegram Stars',
  feature_payment_text: 'Vstavané platby — kartou alebo cez Telegram Stars, bez opúšťania aplikácie.',
  feature_kill_switch_title: 'Vypínač súkromia',
  feature_kill_switch_text: 'Jedno klepnutie okamžite vypne citlivé funkcie, keď je to potrebné.',
