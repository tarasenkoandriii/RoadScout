...
const dict: Dictionary = {
  ...
  feature_ar_scan_text: "La fotocamera del telefono mostra in tempo reale cosa c'è più avanti sulla strada.",
  feature_on_device_title: 'Privacy on-device',
  feature_on_device_text: 'I calcoli restano sul telefono — le coordinate non raggiungono mai il server.',
  feature_registry_title: 'LiveAhead — registro condiviso',
  feature_registry_text: 'Un database condiviso di telecamere e posti di controllo, alimentato dagli utenti.',
  feature_drive_mode_title: 'Modalità guida',
  feature_drive_mode_text: 'Interazione minima con le mani — sicuro da usare mentre si guida.',
  feature_confirm_title: 'Conferma delle segnalazioni',
  feature_confirm_text: 'La community conferma o smentisce i segnali, mantenendo i dati accurati.',
  feature_marketplace_title: 'Marketplace',
  feature_marketplace_text: "Domanda e offerta all'interno dell'app — un meccanismo di scambio bidirezionale.",
  feature_payment_title: 'Pagamenti e Telegram Stars',
  feature_payment_text: "Pagamenti integrati — con carta o Telegram Stars, senza uscire dall'app.",
  feature_kill_switch_title: 'Interruttore per la privacy',
  feature_kill_switch_text: 'Un tocco disattiva all\'istante le funzioni sensibili, quando serve.',
