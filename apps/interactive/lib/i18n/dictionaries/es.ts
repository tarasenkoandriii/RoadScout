...
const dict: Dictionary = {
  ...
  feature_ar_scan_text: 'La cámara del teléfono muestra en tiempo real lo que hay más adelante en la carretera.',
  feature_on_device_title: 'Privacidad on-device',
  feature_on_device_text: 'Los cálculos se quedan en el teléfono — las coordenadas nunca llegan al servidor.',
  feature_registry_title: 'LiveAhead — registro compartido',
  feature_registry_text: 'Una base de datos compartida de cámaras y puntos de control, mantenida por los propios usuarios.',
  feature_drive_mode_title: 'Modo conducción',
  feature_drive_mode_text: 'Mínima interacción manual — seguro de usar mientras conduces.',
  feature_confirm_title: 'Confirmación de reportes',
  feature_confirm_text: 'La comunidad confirma o refuta las marcas, manteniendo los datos precisos.',
  feature_marketplace_title: 'Marketplace',
  feature_marketplace_text: 'Oferta y demanda dentro de la app — un mecanismo de intercambio bidireccional.',
  feature_payment_title: 'Pagos y Telegram Stars',
  feature_payment_text: 'Pagos integrados — con tarjeta o mediante Telegram Stars, sin salir de la app.',
  feature_kill_switch_title: 'Interruptor de privacidad',
  feature_kill_switch_text: 'Un solo toque desactiva al instante las funciones sensibles cuando hace falta.',
